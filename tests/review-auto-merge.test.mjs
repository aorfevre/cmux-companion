...
const fixture = () => ({
  pr: { number: 1, isDraft: false, baseRefName: 'main', headRefOid: 'head', mergeable: 'MERGEABLE',
    reviews: { pageInfo: { hasPreviousPage: false }, nodes: [{ author: { login: 'coderabbitai', __typename: 'Bot' }, state: 'APPROVED', commit: { oid: 'head' } }] },

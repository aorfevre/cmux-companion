...
test('application core does not import concrete adapters or legacy orchestration', () => {
  for (const file of ['service.mjs', 'scheduler.mjs', 'integration-repairs.mjs', 'verification-coordinator.mjs', 'publication-coordinator.mjs', 'reconciler.mjs', 'ports.mjs', 'event-consumers.mjs', 'event-stream.mjs', 'agent-tools.mjs']) {

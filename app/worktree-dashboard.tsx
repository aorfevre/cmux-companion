...
type DashboardRepository = { id: string; name: string; root: string; path: string; archived?: boolean; pullRequestsAvailable: boolean; summary: { worktrees: number; releases: number; sessions: number; needsYou: number; working: number; dirty: number }; worktrees: DashboardWorktree[]; releases: DashboardWorktree[] };

...
function WorktreeCard({ worktree, busy, onOpenWorkspace, onCloseSession, onRemoveWorktree, onLaunch }: { worktree: DashboardWorktree; busy: string; onOpenWorkspace: (id: string) => void; onCloseSession: (session: WorktreeSession) => Promise<void>; onRemoveWorktree: (worktree: DashboardWorktree) => Promise<void>; onLaunch: () => void }) {

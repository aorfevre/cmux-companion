...
export function WorktreeDashboardView({ onOpenWorkspace, onLaunched, onNotice, initialPlanId = "", onPlanOpened }: { onOpenWorkspace: (id: string) => void; onLaunched: (id: string) => Promise<void>; onNotice: (message: string) => void; initialPlanId?: string; onPlanOpened?: () => void }) {
  ...
  const [planTarget, setPlanTarget] = useState<{ repository: DashboardRepository; planId?: string; initialGoal?: string } | null>(null);
  ...
  return <>
    ...
    {planTarget && <WorktreePlannerSheet repository={planTarget.repository} initialPlanId={planTarget.planId} initialGoal={planTarget.initialGoal} onClose={() => { setPlanTarget(null); void loadGoalPlans(); }} onNotice={onNotice} />}

...
type DashboardRepository = { id: string; name: string; root: string; path: string; archived?: boolean; favorite?: boolean; pullRequestsAvailable: boolean; summary: { worktrees: number; sessions: number; needsYou: number; working: number; dirty: number }; worktrees: DashboardWorktree[] };

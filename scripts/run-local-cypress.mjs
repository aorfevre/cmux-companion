...
try {
  ...
  const environment = { ...process.env, CMUX_COMPANION_LOCAL_E2E: '1', CMUX_COMPANION_CYPRESS_BASE_URL: baseUrl,
    ...(demo ? { CMUX_COMPANION_API: demo.manifest.address, CMUX_ORCHESTRATION_CYPRESS_MANIFEST: demo.manifestFile, CMUX_ORCHESTRATION_CYPRESS_READ_ONLY: process.argv.includes('--read-only') ? '1' : '0' } : {}) };
  ...
  if (spec || orchestration) args.push('--spec', spec || 'cypress/e2e/orchestration-core.cy.ts');

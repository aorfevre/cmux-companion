...
| Stable bootstrap | Bootstrap tests select the previous engine after an interrupted current-link switch, reject altered engine digests and legacy transactions, and retain locks for unknown claims/live orphan engines. |

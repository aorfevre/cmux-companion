...
export const USER_COMMANDS = new Set(['rename_goal', 'answer_clarification', 'retry_startup', 'create_goal', 'publish_contract', 'request_revision', 'approve', 'abort', 'authorize_repair', 'retry_task', 'retry_attempt', 'retry_verification', 'retry_integration', 'resume_planner', 'accept_moved_target']);
